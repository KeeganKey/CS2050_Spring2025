...
private class rectangleFromSimpleGeometricShape extends SimpleGeometricShape{
...
// All inheritance still needs to be done! Classes are just place holders.
		...
		public Rectangle() {
			...
			this.color = "unknown"; //placeholder
